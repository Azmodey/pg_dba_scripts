...
Running pgbench, 10 backend connections. WALSync wait, Row Exclusive lock and Replication lag appeared. WalSender process consumes 6.7% CPU. Total CPU load 4.44 %.
